...
const FinancialDashboard = () => {
  // Dados financeiros - agora inicializado vazio
  ...
  const addNewCard = () => {
    ...
    setFinancialData([...financialData, newCard]);
    ...
    <div className="bg-gray-800 rounded-2xl shadow-lg overflow-hidden transform transition hover:scale-[1.01]" style={{boxShadow: '8px 8px 16px rgba(0,0,0,0.4), -8px -8px 16px rgba(50,50,50,0.1)'}}>
      ...
      <div className="p-4">
        ...
        {financialGoals.length > 0 ? (
          ...
          <div className="text-center py-6 bg-gray-700 rounded-xl mt-4">
            <p className="text-gray-300 mb-4">Nenhuma meta financeira definida</p>
            <button 
              onClick={addFinancialGoal}
              className="px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700"
              style={{boxShadow: '3px 3px 6px rgba(0,0,0,0.3), -3px -3px 6px rgba(60,60,60,0.1)'}}
